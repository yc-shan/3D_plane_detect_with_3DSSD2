...
class DemoDataset(DatasetTemplate):
    ...
    def __getitem__(self, index):
        if self.ext == '.bin':
            ...
            points=np.loadtxt(self.sample_file_list[index],dtype=np.float32,delimiter=',')
...
def parse_config():
    ...
    parser.add_argument('--ckpt', type=str, default='/home/sim2real/3DSSD-torch-master/output/3dssd/airplane/ckpt_from0/checkpoint_epoch_150.pth', help='specify the pretrained model')
...
def main():
    ...
    with torch.no_grad():
        ...
        #     data_dict=demo_dataset[-1]
            ...
            V.draw_scenes(
                points=data_dict['points'][:, 1:4], ref_boxes=pred_dicts[0]['pred_boxes'],
