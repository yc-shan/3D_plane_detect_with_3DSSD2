...
# from pcdet.ops.spconv.spconv.utils import VoxelGenerator
...
class DataProcessor(object):
    ...
    def sample_points_sweep(self, data_dict=None, config=None):
        ...
        cur_frame_points = nums_points[0]#num_points 3.20
        prev_frame_points = nums_points[1]#num_points 3.20
